...
function fncAddProduct(){
	//Form 유효성 검사
	if($("input[name='prodName']").val() == null || $("input[name='prodName']").val().length<1){
		alert("상품명은 반드시 입력하여야 합니다.");
		return;
	}
	if($("input[name='prodDetail']").val() == null || $("input[name='prodDetail']").val().length<1){
		alert("상품상세정보는 반드시 입력하여야 합니다.");
		return;
	}
	if($("input[name='manuDate']").val() == null || $("input[name='manuDate']").val().length<1){
		alert("제조일자는 반드시 입력하셔야 합니다.");
		return;
	}
	if($("input[name='price']").val() == null || $("input[name='price']").val().length<1){
